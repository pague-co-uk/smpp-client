...
import { recordException, setAttributes, spanNaming, withObservableSpan, } from '../tracing/index.js';
...
let TelemetryInterceptor = (() => {
    ...
    var TelemetryInterceptor = class {
        ...
        intercept(context, next) {
            ...
            return withObservableSpan(spanNaming.nest(controller, handler), (span) => {
                span.setAttributes({
